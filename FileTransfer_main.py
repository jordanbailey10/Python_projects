...
class ParentWindow(Frame):
    def __init__(self, master):
        ...
        self.labelTxt = Label(text = "Browse Folders", font=("Arial", 12))   ##both of these are required for any widget that is created, one to define it,
        ...
        self.labelTxt = Label(text = "Retrieve Folders", font=("Arial", 12))
        self.labelTxt.grid(row=2,column=1,padx=20, pady=(20,0))
